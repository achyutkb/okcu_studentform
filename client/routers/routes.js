...
const AsyncAcademicDetails = loadable(() => import('../containers/app/AcademicDetailsFormContainer'));
...
const Router = () => (
  <Fragment>
    <Switch>
      ...
      <PrivateRoute exact path="/academicDetails" layout={MainLayout} component={AsyncAcademicDetails} />
